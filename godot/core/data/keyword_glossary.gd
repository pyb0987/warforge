...
var _keywords := {
	...
	"유닛 추가": {
		"theme": "공통",
		"definition": "Layer 1 결과 범주 — 카드에 유닛 1기 이상이 새로 들어가는 모든 동작(제조/부화/번식/징집/순수 추가 등)이 emit 하는 상위 이벤트.",
	},
	"강화 발동": {
		"theme": "공통",
		"definition": "Layer 1 결과 범주 — 강화/개량/성장 등 ATK/HP 영구 증가 동작이 emit 하는 상위 이벤트.",
	},
	"🌳": {
		"theme": "드루이드",
